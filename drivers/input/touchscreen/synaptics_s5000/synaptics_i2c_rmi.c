 ...
 */
static int synaptics_rmi4_sensor_report(struct synaptics_rmi4_data *rmi4_data, const ktime_t timestamp)
{
	int retval;
...
static irqreturn_t synaptics_rmi4_irq(int irq, void *data)
{
	...
	do {
		retval = synaptics_rmi4_sensor_report(rmi4_data, timestamp);
		if (retval < 0) {
